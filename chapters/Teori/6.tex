...
Berikut Contohnya:
\lstinputlisting[firstline=1, lastline=14]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\begin{itemize}
   ...
   \lstinputlisting[firstline=16, lastline=22]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\end{figure}
  ...
  Berfungsi menggambarkan perkembangan nilai-nilai suatu objek penelitian dalam kurun waktu tertentu.
   \lstinputlisting[firstline=24, lastline=37]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\end{figure}
   ...
   Berfungsi untuk menamplikani distribusi /penyebaran suatu data.
    \lstinputlisting[firstline=39, lastline=44]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\end{figure}
    ...
    \lstinputlisting[firstline=46, lastline=53]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\end{figure}
  ...
  Berfungsi untuk  membandingkan sebuah data dengan kumpulan data.
    \lstinputlisting[firstline=55, lastline=68]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\lstinputlisting[firstline=70, lastline=86]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\lstinputlisting[firstline=88, lastline=124]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\lstinputlisting[firstline=126, lastline=131]{src/6/1174074/Teori/teori_6.py}
...
\lstinputlisting[firstline=133, lastline=145]{src/6/1174074/Teori/teori_6.py}
\begin{figure}[H]	
...
\lstinputlisting[firstline=9, lastline=10]{src/6/1174070/teori/T1174070.py}
\subsubsection{Jelaskan bagaimana perbedaan fungsi dan cara pakai untuk berbagai jenis(bar,histogram,scatter,line dll) jenis plot di matplotlib}
\hfill \break
Untuk perbedaan fungsi plot yang digunakan adalah bentuk bentuk grafik yang akan di tampilkan sesuai dengan perintah yang digunakan pada pemogramannya.
...
\lstinputlisting[firstline=94, lastline=104]{src/6/1174070/teori/T1174070.py}
...
dan ini merupakan grafik histogram tersebut.
\begin{figure}[H]	
    \includegraphics[width=5cm]{figures/6/1174070/teori/histogram.png}
    \centering
    \caption{Diagram Histogram}
\end{figure}
\subsubsection{Jelaskan lebih mendalam tentang parameter dari fungsi pie diantaranya labels, colors, startangle, shadow, explode, autopct}
