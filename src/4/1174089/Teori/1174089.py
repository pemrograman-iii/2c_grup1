...
with open('teori2.csv', mode='w') as csv_file:
    ...
    csv_writer.writerow(['1174002', 'tono', 'D4TI2C'])
    csv_writer.writerow(['1174003', 'turbo', 'D4TI2A'])
...
with open('teori3.csv', mode='w') as csv_file:
    ...
    writer.writeheader()
    writer.writerow({'npm': '1174009', 'nama': 'tono', 'kelas': 'D4TI2A'})
    writer.writerow({'npm': '1174010', 'nama': 'surti', 'kelas': 'D4TI2A'})
